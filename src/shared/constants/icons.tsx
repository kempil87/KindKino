...
export const ICONS: Record<string, { data: ReactNode; viewBox?: string }> = {
  arrowLeft: {
    data: (
  ...
  search: {
    data: (
      <path d="m23.707 22.294-5.97-5.97a10.016 10.016 0 1 0-1.413 1.415l5.969 5.969a1 1 0 0 0 1.414-1.414ZM10 18a8 8 0 1 1 8-8 8.009 8.009 0 0 1-8 8Z" />
    ),
    viewBox: '0 0 24 24',
  },
  user: {
